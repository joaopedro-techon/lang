 ...
 * configurações abaixo valiam para o record serializado no Firehose, mas <b>não</b> para os payloads
 * de SQS e SNS, e as duas stacks podiam divergir em silêncio — a mesma data saindo em formato
 * diferente conforme o destino. {@code JsonMapper} estende {@code ObjectMapper}, então quem injeta
 * {@code ObjectMapper} continua recebendo este mesmo bean.
 * <p>
