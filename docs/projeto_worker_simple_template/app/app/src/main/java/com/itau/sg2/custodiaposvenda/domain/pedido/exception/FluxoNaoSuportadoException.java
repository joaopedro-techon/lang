...
/**
 * Não há publicador registrado para o {@link Fluxo} da mensagem.
 * <p>
 * É uma falha de configuração/deploy, não transitória: reentregar a mensagem apenas repetiria o erro
 * até esgotar as tentativas.
 */
