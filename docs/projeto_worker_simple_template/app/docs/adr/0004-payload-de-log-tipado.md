...
Os tipos de domínio de hoje (`PedidoEvent`, `Pedido`) carregam identificadores e valores de pedido,
não PII. **O problema não é o dado de hoje.** É que todo projeto gerado a partir deste template vai
adicionar campos — CPF, conta, nome — e todos passariam a ser logados em INFO sem ninguém decidir
